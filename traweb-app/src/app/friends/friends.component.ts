...
export class FriendsComponent implements OnInit {
  ...
  onRemoveFriend(event: any, friend: User): void {
    ...
    this.userService.updateCurrentUser(userToUpdate).subscribe(
      res => this.toastService.add({severity: 'success', summary: friend.firstName + ' removed from friends', life: 2000}),
      err => this.toastService.add({severity: 'error', summary: 'Failed to remove a friend.', detail: err, life: 20000, closable: true})
    );
  }
